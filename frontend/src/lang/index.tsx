...
export const I18N = {
  en: {
    ...
    searchBySentence: 'Search by sentence…',
    ...
    evalSubmit: 'Evaluate',
    evalSubmitting: 'Evaluating…',
    evalGrammarOk: 'Grammar: OK',
    evalGrammarBad: 'Grammar: needs fixing',
    evalTypoOk: 'No typos',
    evalTypoBad: 'Typo detected',
    evalLevel: 'Level',
    evalCorrection: 'Suggested correction',
    evalFeedback: 'Feedback',
    evalErrQuota: 'Daily limit reached. Try again tomorrow.',
    evalErrUpstream: 'Evaluator is temporarily unavailable.',
    evalErrGeneric: 'Something went wrong. Please try again.',
    evalEmptyInput: 'Type a sentence first.',
  },
  fi: {
    ...
    word: 'Sana',
    sentence: 'Lause',
    searchByWord: 'Hae sanalla…',
    searchBySentence: 'Hae lauseella…',
    noCardsFound: 'Kortteja ei löydy.',
    ...
    save: 'Tallenna',
    create: 'Luo',
    tapToFlip: 'napauta kääntääksesi',
    admin: 'Hallitse kortteja',
    deleteConfirmMsg: 'Haluatko varmasti poistaa tämän kortin? Toimintoa ei voi peruuttaa.',
    prev: '← Edellinen',
    next: 'Seuraava →',
    finnishWord: 'Suomenkielinen sana',
    exSentence: 'Esimerkkilause',
    engTranslation: 'Englanninkielinen käännös',
    username: 'Käyttäjänimi',
    password: 'Salasana',
    fillAllFields: 'Täytä kaikki kentät.',
    enterCreds: 'Syötä käyttäjänimi ja salasana.',
    manageCards: 'Korttien hallinta',
    noCardsYet: 'Tässä aiheessa ei ole vielä kortteja.',
    allTopicsFilter: 'Kaikki aiheet',
    ...
    evalSubmit: 'Arvioi',
    evalSubmitting: 'Arvioidaan…',
    evalGrammarOk: 'Kielioppi: OK',
    evalGrammarBad: 'Kielioppi: korjattavaa',
    evalTypoOk: 'Ei kirjoitusvirheitä',
    evalTypoBad: 'Kirjoitusvirhe havaittu',
    evalLevel: 'Taso',
    evalCorrection: 'Ehdotettu korjaus',
    evalFeedback: 'Palaute',
    evalErrQuota: 'Päivittäinen raja täynnä. Yritä huomenna.',
    evalErrUpstream: 'Arviointipalvelu ei ole käytettävissä.',
    evalErrGeneric: 'Jotain meni pieleen. Yritä uudelleen.',
    evalEmptyInput: 'Kirjoita ensin lause.',
  },
}
