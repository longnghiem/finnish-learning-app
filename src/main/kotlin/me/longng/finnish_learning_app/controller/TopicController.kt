...
import me.longng.finnish_learning_app.controller.dto.TopicResponse
import me.longng.finnish_learning_app.service.TopicService
...
class TopicController(private val topicService: TopicService) {
    ...
    fun getAllTopics(): List<TopicResponse> =
        topicService.getAllTopics().map { TopicResponse.from(it) }
}
